...
pub mod node {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 31] = [
      ...
      ::capnp::word(242, 181, 150, 190, 12, 131, 202, 134),
      ::capnp::word(11, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(61, 24, 210, 151, 77, 18, 174, 235),
    ...
    pub const TYPE_ID: u64 = 0x86ca_830c_be96_b5f2;
  }
}
...
pub mod keyspace {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 16] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(26, 89, 61, 43, 202, 216, 114, 224),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(110, 111, 100, 101, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 75, 101, 121, 115, 112),
    ...
    pub const TYPE_ID: u64 = 0xe072_d8ca_2b3d_591a;
  }
}
...
pub mod keyfield {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 16] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(247, 35, 250, 31, 11, 42, 85, 193),
      ::capnp::word(11, 0, 0, 0, 1, 0, 0, 0),
      ::capnp::word(61, 24, 210, 151, 77, 18, 174, 235),
      ::capnp::word(0, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(110, 111, 100, 101, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 75, 101, 121, 102, 105),
    ...
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub static MEMBERS_BY_NAME : &[u16] = &[];
    pub const TYPE_ID: u64 = 0xc155_2a0b_1ffa_23f7;
  }
}

...
pub mod point {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 47] = [
      ...
      ::capnp::word(230, 242, 181, 156, 190, 58, 198, 202),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(112, 111, 105, 110, 116, 46, 99, 97),
      ::capnp::word(112, 110, 112, 58, 80, 111, 105, 110),
    ...
    pub const TYPE_ID: u64 = 0xcac6_3abe_9cb5_f2e6;
  }
}

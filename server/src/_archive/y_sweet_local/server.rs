...
impl Server {
    ...
    pub async fn serve(self, listener:tokio::net::TcpListener ) -> Result<axum::serve::Serve<axum::routing::IntoMakeService<Router>, Router>, anyhow::Error>{
		...
		*/
		...
		return Ok(axum::serve(listener, app.into_make_service()));
    }
}
